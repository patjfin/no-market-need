    ...
    if (this.state.chartData) {
      ...
      chart = 
        ...
        >
          ...
          <div className="survey-item" onClick={this.changeChart.bind(this, "analytics")}>
          ...
          <div className="survey-item survey-crm" onClick={this.changeChart.bind(this, "crm")}>
          ...
          <div className="survey-item survey-comms" onClick={this.changeChart.bind(this, "comms")}>
          ...
          <div className="survey-item" onClick={this.changeChart.bind(this, "design")}>
          ...
          <div className="survey-item survey-dev" onClick={this.changeChart.bind(this, "dev")}>
          ...
          <div className="survey-item survey-doc" onClick={this.changeChart.bind(this, "documentation")}>
          ...
          <div className="survey-item survey-mgmt" onClick={this.changeChart.bind(this, "mgmt")}>
