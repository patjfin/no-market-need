...
<div style={{display: 'flex', marginBottom: 50, justifyContent: 'center',   alignItems: "flex-start"}}>
  <img
...
[Here it is, in full.](#letter-to-yc)
...
<p id="letter-to-yc" style={{fontSize: 14, fontFamily: "Monospace", backgroundColor: 'ghostwhite', padding: 20, border: '1px solid black', marginTop: 20}}>
